function BackupManager(config) {
    ...
    me.restore = function () {
		...
		'[ "$COMPUTE_TYPE" == "redis" ] && { rm -f /root/redis-backup.sh; wget -O /root/redis-backup.sh %(baseUrl)/scripts/redis-backup.sh; chmod +x /root/redis-backup.sh; bash /root/redis-restore.sh; } || true',
